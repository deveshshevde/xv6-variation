...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	09650513          	add	a0,a0,150 # 1120 <malloc+0xfe>
      92:	325000ef          	jal	bb6 <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	08a50513          	add	a0,a0,138 # 1120 <malloc+0xfe>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b2:	07a50513          	add	a0,a0,122 # 1128 <malloc+0x106>
  ...
  chdir("/");
      ...
      ce:	08650513          	add	a0,a0,134 # 1150 <malloc+0x12e>
      d2:	2ed000ef          	jal	bbe <chdir>
      d6:	00001997          	auipc	s3,0x1
      da:	08a98993          	add	s3,s3,138 # 1160 <malloc+0x13e>
      de:	c489                	beqz	s1,e8 <go+0x74>
      e0:	00001997          	auipc	s3,0x1
      e4:	07898993          	add	s3,s3,120 # 1158 <malloc+0x136>
  uint64 iters = 0;
      e8:	4481                	li	s1,0
  int fd = -1;
      ea:	5a7d                	li	s4,-1
      ec:	00001917          	auipc	s2,0x1
      f0:	34490913          	add	s2,s2,836 # 1430 <malloc+0x40e>
    ...
    if(what == 1){
      ...
      fe:	06e50513          	add	a0,a0,110 # 1168 <malloc+0x146>
    ...
    int what = rand() % 23;
     ...
     14c:	03050513          	add	a0,a0,48 # 1178 <malloc+0x156>
     ...
     15e:	00e50513          	add	a0,a0,14 # 1168 <malloc+0x146>
     162:	23d000ef          	jal	b9e <unlink>
     166:	b755                	j	10a <go+0x96>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     168:	00001517          	auipc	a0,0x1
     16c:	fb850513          	add	a0,a0,-72 # 1120 <malloc+0xfe>
     ...
     17a:	01a50513          	add	a0,a0,26 # 1190 <malloc+0x16e>
     17e:	221000ef          	jal	b9e <unlink>
      chdir("/");
     182:	00001517          	auipc	a0,0x1
     186:	fce50513          	add	a0,a0,-50 # 1150 <malloc+0x12e>
     18a:	235000ef          	jal	bbe <chdir>
     18e:	bfb5                	j	10a <go+0x96>
        printf("grind: chdir grindir failed\n");
     190:	00001517          	auipc	a0,0x1
     194:	f9850513          	add	a0,a0,-104 # 1128 <malloc+0x106>
     ...
     1b0:	fec50513          	add	a0,a0,-20 # 1198 <malloc+0x176>
     ...
     1ca:	fe250513          	add	a0,a0,-30 # 11a8 <malloc+0x186>
     ...
     2b8:	f7c50513          	add	a0,a0,-132 # 1230 <malloc+0x20e>
     ...
     2ea:	f4a50513          	add	a0,a0,-182 # 1230 <malloc+0x20e>
     ...
     2f4:	05b000ef          	jal	b4e <exit>
      ...
      sbrk(6011);
     2f8:	6505                	lui	a0,0x1
     2fa:	77b50513          	add	a0,a0,1915 # 177b <digits+0x2eb>
     ...
     32e:	f2650513          	add	a0,a0,-218 # 1250 <malloc+0x22e>
     ...
     34e:	efe50513          	add	a0,a0,-258 # 1248 <malloc+0x226>
     ...
     364:	ed050513          	add	a0,a0,-304 # 1230 <malloc+0x20e>
     ...
     376:	eee50513          	add	a0,a0,-274 # 1260 <malloc+0x23e>
     ...
     3a8:	e8c50513          	add	a0,a0,-372 # 1230 <malloc+0x20e>
     ...
     3e8:	e9450513          	add	a0,a0,-364 # 1278 <malloc+0x256>
     ...
     404:	e9058593          	add	a1,a1,-368 # 1290 <malloc+0x26e>
     ...
     434:	e6850513          	add	a0,a0,-408 # 1298 <malloc+0x276>
     438:	337000ef          	jal	f6e <printf>
     43c:	bfe9                	j	416 <go+0x3a2>
          printf("grind: pipe read failed\n");
     43e:	00001517          	auipc	a0,0x1
     442:	e7a50513          	add	a0,a0,-390 # 12b8 <malloc+0x296>
     446:	329000ef          	jal	f6e <printf>
     44a:	b7c5                	j	42a <go+0x3b6>
        printf("grind: fork failed\n");
     44c:	00001517          	auipc	a0,0x1
     450:	de450513          	add	a0,a0,-540 # 1230 <malloc+0x20e>
     ...
     4c6:	d6e50513          	add	a0,a0,-658 # 1230 <malloc+0x20e>
     ...
     4d8:	e0c50513          	add	a0,a0,-500 # 12e0 <malloc+0x2be>
     ...
     4e8:	dfc50513          	add	a0,a0,-516 # 12e0 <malloc+0x2be>
     ...
     4fc:	d9858593          	add	a1,a1,-616 # 1290 <malloc+0x26e>
     ...
     536:	dae50513          	add	a0,a0,-594 # 12e0 <malloc+0x2be>
     53a:	664000ef          	jal	b9e <unlink>
     53e:	b6f1                	j	10a <go+0x96>
        printf("grind: create c failed\n");
     540:	00001517          	auipc	a0,0x1
     544:	da850513          	add	a0,a0,-600 # 12e8 <malloc+0x2c6>
     ...
     556:	dae50513          	add	a0,a0,-594 # 1300 <malloc+0x2de>
     ...
     568:	db450513          	add	a0,a0,-588 # 1318 <malloc+0x2f6>
     ...
     57c:	db850513          	add	a0,a0,-584 # 1330 <malloc+0x30e>
     ...
     58e:	dce50513          	add	a0,a0,-562 # 1358 <malloc+0x336>
     ...
     63c:	dc058593          	add	a1,a1,-576 # 13f8 <malloc+0x3d6>
     ...
     652:	c2a58593          	add	a1,a1,-982 # 1278 <malloc+0x256>
     656:	4509                	li	a0,2
     ...
     666:	c1658593          	add	a1,a1,-1002 # 1278 <malloc+0x256>
     66a:	4509                	li	a0,2
     ...
     6a6:	cde58593          	add	a1,a1,-802 # 1380 <malloc+0x35e>
     6aa:	4509                	li	a0,2
     ...
     702:	b3258593          	add	a1,a1,-1230 # 1230 <malloc+0x20e>
     706:	4509                	li	a0,2
     ...
     736:	c4e58593          	add	a1,a1,-946 # 1380 <malloc+0x35e>
     73a:	4509                	li	a0,2
     ...
     766:	c1e58593          	add	a1,a1,-994 # 1380 <malloc+0x35e>
     76a:	4509                	li	a0,2
     ...
     7b6:	a7e58593          	add	a1,a1,-1410 # 1230 <malloc+0x20e>
     7ba:	4509                	li	a0,2
     ...
     7d4:	c3050513          	add	a0,a0,-976 # 1400 <malloc+0x3de>
...
iter()
{
  ...
  unlink("a");
     ...
     7ee:	a5e50513          	add	a0,a0,-1442 # 1248 <malloc+0x226>
     7f2:	3ac000ef          	jal	b9e <unlink>
  unlink("b");
     7f6:	00001517          	auipc	a0,0x1
     7fa:	a0250513          	add	a0,a0,-1534 # 11f8 <malloc+0x1d6>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     830:	a0450513          	add	a0,a0,-1532 # 1230 <malloc+0x20e>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     854:	629c                	ld	a5,0(a3)
     856:	6709                	lui	a4,0x2
     858:	c0970713          	add	a4,a4,-1015 # 1c09 <digits+0x779>
    ...
    printf("grind: fork failed\n");
     ...
     86a:	9ca50513          	add	a0,a0,-1590 # 1230 <malloc+0x20e>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c36:	85e50513          	add	a0,a0,-1954 # 1490 <digits>
     c3a:	883a                	mv	a6,a4
     c3c:	2705                	addw	a4,a4,1
     c3e:	02c5f7bb          	remuw	a5,a1,a2
     c42:	1782                	sll	a5,a5,0x20
     c44:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     f1a:	51290913          	add	s2,s2,1298 # 1428 <malloc+0x406>
        for(; *s; s++)
...
malloc(uint nbytes)
{
    ...
    102c:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    102e:	02051493          	sll	s1,a0,0x20
    1032:	9081                	srl	s1,s1,0x20
    1034:	04bd                	add	s1,s1,15
    1036:	8091                	srl	s1,s1,0x4
    1038:	0014899b          	addw	s3,s1,1
    103c:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1072:	fa290913          	add	s2,s2,-94 # 2010 <freep>
  if(p == (char*)-1)
    1076:	5afd                	li	s5,-1
    ...
    1086:	38678793          	add	a5,a5,902 # 2408 <base>
  ...
  if(p == (char*)-1)
    ...
    10e8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    10ea:	02071693          	sll	a3,a4,0x20
    10ee:	01c6d713          	srl	a4,a3,0x1c
