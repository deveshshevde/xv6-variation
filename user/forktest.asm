...
forktest(void)
{
  ...
  36:	3b650513          	add	a0,a0,950 # 3e8 <off+0x8>
  ...
  58:	3e450513          	add	a0,a0,996 # 438 <off+0x58>
  ...
  6e:	38e50513          	add	a0,a0,910 # 3f8 <off+0x18>
  ...
  80:	39450513          	add	a0,a0,916 # 410 <off+0x30>
  ...
  b0:	37c50513          	add	a0,a0,892 # 428 <off+0x48>
