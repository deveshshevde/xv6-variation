...
ls(char *path)
{
  ...
  f4:	9e050513          	add	a0,a0,-1568 # ad0 <malloc+0x12a>
 ...
 11e:	98658593          	add	a1,a1,-1658 # aa0 <malloc+0xfa>
 122:	4509                	li	a0,2
 ...
 130:	98c58593          	add	a1,a1,-1652 # ab8 <malloc+0x112>
 134:	4509                	li	a0,2
 ...
 15a:	98a50513          	add	a0,a0,-1654 # ae0 <malloc+0x13a>
 ...
 19e:	936a0a13          	add	s4,s4,-1738 # ad0 <malloc+0x12a>
        printf("ls: cannot stat %s\n", buf);
 1a2:	00001a97          	auipc	s5,0x1
 1a6:	916a8a93          	add	s5,s5,-1770 # ab8 <malloc+0x112>
...
main(int argc, char *argv[])
{
 ...
 25a:	8a250513          	add	a0,a0,-1886 # af8 <malloc+0x152>
...
putc(int fd, char c)
{
 57a:	1101                	add	sp,sp,-32
 57c:	ec06                	sd	ra,24(sp)
 57e:	e822                	sd	s0,16(sp)
 580:	1000                	add	s0,sp,32
 582:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 586:	4605                	li	a2,1
 588:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5ba:	55250513          	add	a0,a0,1362 # b08 <digits>
 5be:	883a                	mv	a6,a4
 5c0:	2705                	addw	a4,a4,1
 5c2:	02c5f7bb          	remuw	a5,a1,a2
 5c6:	1782                	sll	a5,a5,0x20
 5c8:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 850:	2bcb8b93          	add	s7,s7,700 # b08 <digits>
 854:	03c9d793          	srl	a5,s3,0x3c
 858:	97de                	add	a5,a5,s7
 85a:	0007c583          	lbu	a1,0(a5)
 85e:	855a                	mv	a0,s6
 860:	d1bff0ef          	jal	57a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 864:	0992                	sll	s3,s3,0x4
 866:	397d                	addw	s2,s2,-1
 ...
 89e:	26690913          	add	s2,s2,614 # b00 <malloc+0x15a>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 a0a:	61a78793          	add	a5,a5,1562 # 1020 <base>
 ...
 a6c:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a6e:	02071693          	sll	a3,a4,0x20
 a72:	01c6d713          	srl	a4,a3,0x1c
