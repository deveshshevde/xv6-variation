...
main(int argc, char *argv[])
{
  ...
  14:	88058593          	add	a1,a1,-1920 # 890 <malloc+0x104>
  18:	4509                	li	a0,2
  ...
  42:	86a58593          	add	a1,a1,-1942 # 8a8 <malloc+0x11c>
  46:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a0:	52c50513          	add	a0,a0,1324 # 8c8 <digits>
 3a4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 636:	296b8b93          	add	s7,s7,662 # 8c8 <digits>
 ...
 64a:	0992                	sll	s3,s3,0x4
 64c:	397d                	addw	s2,s2,-1
 ...
 684:	24090913          	add	s2,s2,576 # 8c0 <malloc+0x134>
        for(; *s; s++)
