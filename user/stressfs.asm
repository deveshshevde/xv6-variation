...
main(int argc, char *argv[])
{
  ...
  1a:	92a78793          	add	a5,a5,-1750 # 940 <malloc+0x12a>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	8e450513          	add	a0,a0,-1820 # 910 <malloc+0xfa>
  ...
  60:	8cc50513          	add	a0,a0,-1844 # 928 <malloc+0x112>
...
//    printf(fd, "%d\n", i);
  ...
  9e:	89e50513          	add	a0,a0,-1890 # 938 <malloc+0x122>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 42a:	53250513          	add	a0,a0,1330 # 958 <digits>
 42e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6c0:	29cb8b93          	add	s7,s7,668 # 958 <digits>
 6c4:	03c9d793          	srl	a5,s3,0x3c
 6c8:	97de                	add	a5,a5,s7
 6ca:	0007c583          	lbu	a1,0(a5)
 6ce:	855a                	mv	a0,s6
 6d0:	d1bff0ef          	jal	3ea <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6d4:	0992                	sll	s3,s3,0x4
 6d6:	397d                	addw	s2,s2,-1
 ...
 70e:	24690913          	add	s2,s2,582 # 950 <malloc+0x13a>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 820:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 822:	02051493          	sll	s1,a0,0x20
 826:	9081                	srl	s1,s1,0x20
 828:	04bd                	add	s1,s1,15
 82a:	8091                	srl	s1,s1,0x4
 82c:	0014899b          	addw	s3,s1,1
 830:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 866:	79e90913          	add	s2,s2,1950 # 1000 <freep>
  if(p == (char*)-1)
 86a:	5afd                	li	s5,-1
