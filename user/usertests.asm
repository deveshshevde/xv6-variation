...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	3da78793          	add	a5,a5,986 # 73e8 <malloc+0x2494>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	fea50513          	add	a0,a0,-22 # 5050 <malloc+0xfc>
      ...
      94:	8082                	ret
{
      ...
      a4:	fd050513          	add	a0,a0,-48 # 5070 <malloc+0x11c>
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	fc850513          	add	a0,a0,-56 # 5088 <malloc+0x134>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	fd250513          	add	a0,a0,-46 # 50a8 <malloc+0x154>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	f9e50513          	add	a0,a0,-98 # 5090 <malloc+0x13c>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	fb250513          	add	a0,a0,-78 # 50b8 <malloc+0x164>
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	f6450513          	add	a0,a0,-156 # 50e0 <malloc+0x18c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	f5a50513          	add	a0,a0,-166 # 5100 <malloc+0x1ac>
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	e7650513          	add	a0,a0,-394 # 5138 <malloc+0x1e4>
     ...
     2e0:	e7c50513          	add	a0,a0,-388 # 5158 <malloc+0x204>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	e7250513          	add	a0,a0,-398 # 5170 <malloc+0x21c>
     306:	7ca040ef          	jal	4ad0 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	e6298993          	add	s3,s3,-414 # 5170 <malloc+0x21c>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	e2650513          	add	a0,a0,-474 # 5170 <malloc+0x21c>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    exit(1);
     ...
     386:	df650513          	add	a0,a0,-522 # 5178 <malloc+0x224>
    ...
    printf("open junk failed\n");
     ...
     398:	de450513          	add	a0,a0,-540 # 5178 <malloc+0x224>
  ...
  unlink("junk");
     ...
     3b0:	dc450513          	add	a0,a0,-572 # 5170 <malloc+0x21c>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	f5878793          	add	a5,a5,-168 # 73e8 <malloc+0x2494>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	ce2a0a13          	add	s4,s4,-798 # 51a0 <malloc+0x24c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	c6450513          	add	a0,a0,-924 # 51a8 <malloc+0x254>
     ...
     55e:	c6650513          	add	a0,a0,-922 # 51c0 <malloc+0x26c>
     ...
     574:	c8050513          	add	a0,a0,-896 # 51f0 <malloc+0x29c>
     ...
     586:	c9e50513          	add	a0,a0,-866 # 5220 <malloc+0x2cc>
     ...
     59c:	c9850513          	add	a0,a0,-872 # 5230 <malloc+0x2dc>
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	e2a78793          	add	a5,a5,-470 # 73e8 <malloc+0x2494>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	c6ea0a13          	add	s4,s4,-914 # 5260 <malloc+0x30c>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	afea8a93          	add	s5,s5,-1282 # 50f8 <malloc+0x1a4>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	bea50513          	add	a0,a0,-1046 # 5268 <malloc+0x314>
     ...
     698:	bec50513          	add	a0,a0,-1044 # 5280 <malloc+0x32c>
     ...
     6aa:	b7a50513          	add	a0,a0,-1158 # 5220 <malloc+0x2cc>
     ...
     6bc:	bf850513          	add	a0,a0,-1032 # 52b0 <malloc+0x35c>
     ...
     6d2:	bfa50513          	add	a0,a0,-1030 # 52c8 <malloc+0x374>
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	9b850513          	add	a0,a0,-1608 # 50e0 <malloc+0x18c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	99450513          	add	a0,a0,-1644 # 50e0 <malloc+0x18c>
     754:	36c040ef          	jal	4ac0 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	98450513          	add	a0,a0,-1660 # 50e0 <malloc+0x18c>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	bca58593          	add	a1,a1,-1078 # 5358 <malloc+0x404>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	91c50513          	add	a0,a0,-1764 # 50e0 <malloc+0x18c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	b0050513          	add	a0,a0,-1280 # 52f8 <malloc+0x3a4>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	b0c50513          	add	a0,a0,-1268 # 5318 <malloc+0x3c4>
     814:	68c040ef          	jal	4ea0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	b0c50513          	add	a0,a0,-1268 # 5328 <malloc+0x3d4>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	b1850513          	add	a0,a0,-1256 # 5348 <malloc+0x3f4>
     838:	668040ef          	jal	4ea0 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	ae850513          	add	a0,a0,-1304 # 5328 <malloc+0x3d4>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	b0a50513          	add	a0,a0,-1270 # 5360 <malloc+0x40c>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	b1450513          	add	a0,a0,-1260 # 5380 <malloc+0x42c>
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	b0850513          	add	a0,a0,-1272 # 53a0 <malloc+0x44c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	b1c98993          	add	s3,s3,-1252 # 53c8 <malloc+0x474>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	b4ca8a93          	add	s5,s5,-1204 # 5400 <malloc+0x4ac>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	ab250513          	add	a0,a0,-1358 # 53a0 <malloc+0x44c>
  ...
  if(unlink("small") < 0){
     ...
     922:	a8250513          	add	a0,a0,-1406 # 53a0 <malloc+0x44c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	a6450513          	add	a0,a0,-1436 # 53a8 <malloc+0x454>
    ...
    exit(1);
     ...
     95e:	a7e50513          	add	a0,a0,-1410 # 53d8 <malloc+0x484>
     ...
     974:	aa050513          	add	a0,a0,-1376 # 5410 <malloc+0x4bc>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	ab450513          	add	a0,a0,-1356 # 5438 <malloc+0x4e4>
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	ac050513          	add	a0,a0,-1344 # 5458 <malloc+0x504>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	ac450513          	add	a0,a0,-1340 # 5470 <malloc+0x51c>
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	aba50513          	add	a0,a0,-1350 # 5490 <malloc+0x53c>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	a7450513          	add	a0,a0,-1420 # 5490 <malloc+0x53c>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	a3c50513          	add	a0,a0,-1476 # 5498 <malloc+0x544>
    ...
    exit(1);
     ...
     a76:	a4650513          	add	a0,a0,-1466 # 54b8 <malloc+0x564>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	a5a50513          	add	a0,a0,-1446 # 54e0 <malloc+0x58c>
  ...
  if(unlink("big") < 0){
     ...
     aaa:	9ea50513          	add	a0,a0,-1558 # 5490 <malloc+0x53c>
     ...
     ad0:	a3450513          	add	a0,a0,-1484 # 5500 <malloc+0x5ac>
     ...
     ae6:	a4650513          	add	a0,a0,-1466 # 5528 <malloc+0x5d4>
     ...
     afc:	a4850513          	add	a0,a0,-1464 # 5540 <malloc+0x5ec>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	a5c50513          	add	a0,a0,-1444 # 5568 <malloc+0x614>
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	a4e50513          	add	a0,a0,-1458 # 5580 <malloc+0x62c>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	a6a58593          	add	a1,a1,-1430 # 55b0 <malloc+0x65c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	a2650513          	add	a0,a0,-1498 # 5580 <malloc+0x62c>
  ...
  unlink("unlinkread");
     ...
     be6:	99e50513          	add	a0,a0,-1634 # 5580 <malloc+0x62c>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	99250513          	add	a0,a0,-1646 # 5590 <malloc+0x63c>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	9a650513          	add	a0,a0,-1626 # 55b8 <malloc+0x664>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	9b250513          	add	a0,a0,-1614 # 55d8 <malloc+0x684>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	9c650513          	add	a0,a0,-1594 # 5600 <malloc+0x6ac>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	9d250513          	add	a0,a0,-1582 # 5620 <malloc+0x6cc>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	9de50513          	add	a0,a0,-1570 # 5640 <malloc+0x6ec>
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	9de50513          	add	a0,a0,-1570 # 5660 <malloc+0x70c>
     c8a:	647030ef          	jal	4ad0 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	9da50513          	add	a0,a0,-1574 # 5668 <malloc+0x714>
     c96:	63b030ef          	jal	4ad0 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	9c250513          	add	a0,a0,-1598 # 5660 <malloc+0x70c>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	8fe58593          	add	a1,a1,-1794 # 55b0 <malloc+0x65c>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	8e650513          	add	a0,a0,-1818 # 5670 <malloc+0x71c>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	8ea50513          	add	a0,a0,-1814 # 5688 <malloc+0x734>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	8ee50513          	add	a0,a0,-1810 # 56a0 <malloc+0x74c>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	8fa50513          	add	a0,a0,-1798 # 56c0 <malloc+0x76c>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	91650513          	add	a0,a0,-1770 # 56f0 <malloc+0x79c>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	91a50513          	add	a0,a0,-1766 # 5708 <malloc+0x7b4>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	91e50513          	add	a0,a0,-1762 # 5720 <malloc+0x7cc>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	93250513          	add	a0,a0,-1742 # 5748 <malloc+0x7f4>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	94e50513          	add	a0,a0,-1714 # 5778 <malloc+0x824>
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	94498993          	add	s3,s3,-1724 # 5798 <malloc+0x844>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	91c50513          	add	a0,a0,-1764 # 57a8 <malloc+0x854>
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	91450513          	add	a0,a0,-1772 # 57c8 <malloc+0x874>
     ebc:	415030ef          	jal	4ad0 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	90450513          	add	a0,a0,-1788 # 57c8 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	8eaa0a13          	add	s4,s4,-1814 # 57c8 <malloc+0x874>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	89c50513          	add	a0,a0,-1892 # 57c8 <malloc+0x874>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	83c50513          	add	a0,a0,-1988 # 57d0 <malloc+0x87c>
    ...
    exit(1);
     ...
     fb2:	84250513          	add	a0,a0,-1982 # 57f0 <malloc+0x89c>
     ...
     fc6:	85650513          	add	a0,a0,-1962 # 5818 <malloc+0x8c4>
...
0000000000001000 <badarg>:
{
    ...
    101e:	06e98993          	add	s3,s3,110 # 5088 <malloc+0x134>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	8d878793          	add	a5,a5,-1832 # 6968 <malloc+0x1a14>
  ...
  if(pid == 0){
    ...
    10e8:	30478793          	add	a5,a5,772 # 73e8 <malloc+0x2494>
    ...
    110c:	f8050513          	add	a0,a0,-128 # 5088 <malloc+0x134>
    ...
    1120:	7a450513          	add	a0,a0,1956 # 58c0 <malloc+0x96c>
    ...
    1138:	70450513          	add	a0,a0,1796 # 5838 <malloc+0x8e4>
    ...
    1150:	70c50513          	add	a0,a0,1804 # 5858 <malloc+0x904>
    ...
    116a:	71250513          	add	a0,a0,1810 # 5878 <malloc+0x924>
    ...
    1182:	72250513          	add	a0,a0,1826 # 58a0 <malloc+0x94c>
    ...
    1194:	cf850513          	add	a0,a0,-776 # 6e88 <malloc+0x1f34>
  ...
  if(st != 747){
    ...
    11ce:	71e50513          	add	a0,a0,1822 # 58e8 <malloc+0x994>
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	ef450513          	add	a0,a0,-268 # 50e0 <malloc+0x18c>
  ...
  if(pid == 0){
    ...
    1216:	ecea0a13          	add	s4,s4,-306 # 50e0 <malloc+0x18c>
      int n = write(fd, "1234567890", 10);
    121a:	00004a97          	auipc	s5,0x4
    121e:	72ea8a93          	add	s5,s5,1838 # 5948 <malloc+0x9f4>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	6a250513          	add	a0,a0,1698 # 5918 <malloc+0x9c4>
    ...
    128e:	6a650513          	add	a0,a0,1702 # 5930 <malloc+0x9dc>
    ...
    12a4:	6b850513          	add	a0,a0,1720 # 5958 <malloc+0xa04>
    ...
    12c2:	e22a0a13          	add	s4,s4,-478 # 50e0 <malloc+0x18c>
    int n = write(fd, "xxx", 3);
    12c6:	00004a97          	auipc	s5,0x4
    12ca:	6b2a8a93          	add	s5,s5,1714 # 5978 <malloc+0xa24>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	de050513          	add	a0,a0,-544 # 50e0 <malloc+0x18c>
  ...
  exit(xstatus);
    ...
    131a:	61a50513          	add	a0,a0,1562 # 5930 <malloc+0x9dc>
    ...
    1330:	65450513          	add	a0,a0,1620 # 5980 <malloc+0xa2c>
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	d3e78793          	add	a5,a5,-706 # 5088 <malloc+0x134>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00004797          	auipc	a5,0x4
    135a:	64a78793          	add	a5,a5,1610 # 59a0 <malloc+0xa4c>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00004517          	auipc	a0,0x4
    136a:	64250513          	add	a0,a0,1602 # 59a8 <malloc+0xa54>
  ...
  if(pid == 0) {
    ...
    138e:	61e50513          	add	a0,a0,1566 # 59a8 <malloc+0xa54>
    ...
    13a6:	62650513          	add	a0,a0,1574 # 59c8 <malloc+0xa74>
    ...
    13bc:	56050513          	add	a0,a0,1376 # 5918 <malloc+0x9c4>
    ...
    13d0:	5e450513          	add	a0,a0,1508 # 59b0 <malloc+0xa5c>
    ...
    13e6:	ca650513          	add	a0,a0,-858 # 5088 <malloc+0x134>
  ...
  if(xstatus != 0)
    ...
    140e:	5ce50513          	add	a0,a0,1486 # 59d8 <malloc+0xa84>
    ...
    1422:	5d250513          	add	a0,a0,1490 # 59f0 <malloc+0xa9c>
    1426:	27b030ef          	jal	4ea0 <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00004517          	auipc	a0,0x4
    1432:	57a50513          	add	a0,a0,1402 # 59a8 <malloc+0xa54>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	00850513          	add	a0,a0,8 # 5458 <malloc+0x504>
    ...
    1468:	4cc50513          	add	a0,a0,1228 # 5930 <malloc+0x9dc>
  ...
  unlink("echo-ok");
    ...
    147a:	53250513          	add	a0,a0,1330 # 59a8 <malloc+0xa54>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	56c50513          	add	a0,a0,1388 # 5a08 <malloc+0xab4>
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	4d850513          	add	a0,a0,1240 # 5a20 <malloc+0xacc>
    ...
    1582:	42da8a93          	add	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	47650513          	add	a0,a0,1142 # 5a38 <malloc+0xae4>
    ...
    15da:	47a50513          	add	a0,a0,1146 # 5a50 <malloc+0xafc>
    ...
    160a:	46250513          	add	a0,a0,1122 # 5a68 <malloc+0xb14>
    ...
    1642:	44a50513          	add	a0,a0,1098 # 5a88 <malloc+0xb34>
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	27850513          	add	a0,a0,632 # 5918 <malloc+0x9c4>
    ...
    16b8:	3ec50513          	add	a0,a0,1004 # 5aa0 <malloc+0xb4c>
    ...
    16cc:	3f050513          	add	a0,a0,1008 # 5ab8 <malloc+0xb64>
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	1f450513          	add	a0,a0,500 # 5918 <malloc+0x9c4>
    ...
    1740:	1dc50513          	add	a0,a0,476 # 5918 <malloc+0x9c4>
...
0000000000001752 <forkfork>:
{
    ...
    179e:	33e50513          	add	a0,a0,830 # 5ad8 <malloc+0xb84>
    ...
    17a8:	2d8030ef          	jal	4a80 <exit>
{
    ...
    17da:	31250513          	add	a0,a0,786 # 5ae8 <malloc+0xb94>
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	67850513          	add	a0,a0,1656 # 6e88 <malloc+0x1f34>
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	08650513          	add	a0,a0,134 # 5918 <malloc+0x9c4>
    ...
    18ba:	0fa50513          	add	a0,a0,250 # 59b0 <malloc+0xa5c>
    ...
    1918:	1f450513          	add	a0,a0,500 # 5b08 <malloc+0xbb4>
    ...
    193c:	1e850513          	add	a0,a0,488 # 5b20 <malloc+0xbcc>
    ...
    198e:	1be50513          	add	a0,a0,446 # 5b48 <malloc+0xbf4>
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	6d450513          	add	a0,a0,1748 # 50f8 <malloc+0x1a4>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	6a0b0b13          	add	s6,s6,1696 # 50f8 <malloc+0x1a4>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	110c0c13          	add	s8,s8,272 # 5b70 <malloc+0xc1c>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	eac50513          	add	a0,a0,-340 # 5918 <malloc+0x9c4>
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	0b450513          	add	a0,a0,180 # 5bc0 <malloc+0xc6c>
    ...
    1b28:	05450513          	add	a0,a0,84 # 5b78 <malloc+0xc24>
    ...
    1b3c:	05850513          	add	a0,a0,88 # 5b90 <malloc+0xc3c>
    ...
    1b50:	05c50513          	add	a0,a0,92 # 5ba8 <malloc+0xc54>
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	d2e50513          	add	a0,a0,-722 # 5918 <malloc+0x9c4>
    ...
    1c08:	fe450513          	add	a0,a0,-28 # 5be8 <malloc+0xc94>
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	ca650513          	add	a0,a0,-858 # 5918 <malloc+0x9c4>
    ...
    1c9a:	f7250513          	add	a0,a0,-142 # 5c08 <malloc+0xcb4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	f3a50513          	add	a0,a0,-198 # 5c20 <malloc+0xccc>
    ...
    1cfe:	c1e50513          	add	a0,a0,-994 # 5918 <malloc+0x9c4>
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	6c678793          	add	a5,a5,1734 # 73e8 <malloc+0x2494>
  ...
  exit(0);
    ...
    1d8e:	ebe50513          	add	a0,a0,-322 # 5c48 <malloc+0xcf4>
    ...
    1da2:	b7a50513          	add	a0,a0,-1158 # 5918 <malloc+0x9c4>
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	07e50513          	add	a0,a0,126 # 6e88 <malloc+0x1f34>
    ...
    1ea0:	dcc50513          	add	a0,a0,-564 # 5c68 <malloc+0xd14>
    ...
    1eb8:	2a450513          	add	a0,a0,676 # 5158 <malloc+0x204>
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	a4078793          	add	a5,a5,-1472 # 6968 <malloc+0x1a14>
  ...
  if(ret != -1){
    ...
    1f66:	d1e50513          	add	a0,a0,-738 # 5c80 <malloc+0xd2c>
    ...
    1f7c:	8c050513          	add	a0,a0,-1856 # 5838 <malloc+0x8e4>
    ...
    1f92:	8ca50513          	add	a0,a0,-1846 # 5858 <malloc+0x904>
    ...
    1faa:	8d250513          	add	a0,a0,-1838 # 5878 <malloc+0x924>
    ...
    1fc0:	8e450513          	add	a0,a0,-1820 # 58a0 <malloc+0x94c>
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	cc850513          	add	a0,a0,-824 # 5cc0 <malloc+0xd6c>
  ...
  if(n >= 0){
    ...
    2024:	cc050513          	add	a0,a0,-832 # 5ce0 <malloc+0xd8c>
    ...
    203a:	c5250513          	add	a0,a0,-942 # 5c88 <malloc+0xd34>
    ...
    204e:	c5650513          	add	a0,a0,-938 # 5ca0 <malloc+0xd4c>
    ...
    2060:	c6c50513          	add	a0,a0,-916 # 5cc8 <malloc+0xd74>
  ...
  unlink("rwsbrk");
    ...
    2078:	c4c50513          	add	a0,a0,-948 # 5cc0 <malloc+0xd6c>
    207c:	255020ef          	jal	4ad0 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	1de50513          	add	a0,a0,478 # 5260 <malloc+0x30c>
  ...
  if(n >= 0){
    ...
    20a8:	c6c50513          	add	a0,a0,-916 # 5d10 <malloc+0xdbc>
    ...
    20ba:	c1250513          	add	a0,a0,-1006 # 5cc8 <malloc+0xd74>
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	c1850513          	add	a0,a0,-1000 # 5d38 <malloc+0xde4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	be850513          	add	a0,a0,-1048 # 5d58 <malloc+0xe04>
  ...
  if(c != a + 1){
    ...
    21c0:	bfc50513          	add	a0,a0,-1028 # 5db8 <malloc+0xe64>
    ...
    21da:	ba250513          	add	a0,a0,-1118 # 5d78 <malloc+0xe24>
    ...
    21ee:	bae50513          	add	a0,a0,-1106 # 5d98 <malloc+0xe44>
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22f0:	aec50513          	add	a0,a0,-1300 # 5dd8 <malloc+0xe84>
    ...
    2304:	b2050513          	add	a0,a0,-1248 # 5e20 <malloc+0xecc>
    ...
    231c:	b2850513          	add	a0,a0,-1240 # 5e40 <malloc+0xeec>
    ...
    2334:	b5050513          	add	a0,a0,-1200 # 5e80 <malloc+0xf2c>
    ...
    2348:	b6c50513          	add	a0,a0,-1172 # 5eb0 <malloc+0xf5c>
    ...
    2360:	b8c50513          	add	a0,a0,-1140 # 5ee8 <malloc+0xf94>
...
000000000000236e <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    238e:	b8650513          	add	a0,a0,-1146 # 5f10 <malloc+0xfbc>
    2392:	72e020ef          	jal	4ac0 <open>
    2396:	84aa                	mv	s1,a0
  unlink("sbrk");
    2398:	00004517          	auipc	a0,0x4
    239c:	b7850513          	add	a0,a0,-1160 # 5f10 <malloc+0xfbc>
  ...
  if(pipe((int *) a) != 0){
    ...
    23dc:	b4050513          	add	a0,a0,-1216 # 5f18 <malloc+0xfc4>
    ...
    23f0:	b4450513          	add	a0,a0,-1212 # 5f30 <malloc+0xfdc>
    ...
    2404:	62050513          	add	a0,a0,1568 # 5a20 <malloc+0xacc>
...
0000000000002412 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2426:	b2650513          	add	a0,a0,-1242 # 5f48 <malloc+0xff4>
  ...
  close(fd);
    ...
    245e:	4d650513          	add	a0,a0,1238 # 5930 <malloc+0x9dc>
...
000000000000246c <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2494:	9f850513          	add	a0,a0,-1544 # 6e88 <malloc+0x1f34>
  ...
  if(pid == 0){
    ...
    24ce:	9be50513          	add	a0,a0,-1602 # 6e88 <malloc+0x1f34>
  ...
  if(pid == 0){
    ...
    250e:	97e50513          	add	a0,a0,-1666 # 6e88 <malloc+0x1f34>
...
00000000000025f8 <execout>:
{
  ...
  exit(0);
    ...
    262e:	85e50513          	add	a0,a0,-1954 # 6e88 <malloc+0x1f34>
    ...
    266e:	a1e50513          	add	a0,a0,-1506 # 5088 <malloc+0x134>
    2672:	faa43c23          	sd	a0,-72(s0)
    2676:	00003797          	auipc	a5,0x3
    267a:	a8278793          	add	a5,a5,-1406 # 50f8 <malloc+0x1a4>
...
0000000000002694 <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26c4:	91050513          	add	a0,a0,-1776 # 5fd0 <malloc+0x107c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26da:	97250513          	add	a0,a0,-1678 # 6048 <malloc+0x10f4>
  ...
  unlink("12345678901234");
    ...
    275e:	7f650513          	add	a0,a0,2038 # 5f50 <malloc+0xffc>
    ...
    2772:	82a50513          	add	a0,a0,-2006 # 5f98 <malloc+0x1044>
    ...
    2786:	87e50513          	add	a0,a0,-1922 # 6000 <malloc+0x10ac>
    ...
    279a:	8e250513          	add	a0,a0,-1822 # 6078 <malloc+0x1124>
    ...
    27ae:	92e50513          	add	a0,a0,-1746 # 60d8 <malloc+0x1184>
    ...
    27c2:	97250513          	add	a0,a0,-1678 # 6130 <malloc+0x11dc>
...
00000000000027d0 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    280a:	96250513          	add	a0,a0,-1694 # 6168 <malloc+0x1214>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2836:	94650513          	add	a0,a0,-1722 # 6178 <malloc+0x1224>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29da:	7c250513          	add	a0,a0,1986 # 6198 <malloc+0x1244>
...
00000000000029e4 <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a40:	79450513          	add	a0,a0,1940 # 61d0 <malloc+0x127c>
    ...
    2a54:	79850513          	add	a0,a0,1944 # 61e8 <malloc+0x1294>
    ...
    2a68:	7b450513          	add	a0,a0,1972 # 6218 <malloc+0x12c4>
    ...
    2a7c:	7c850513          	add	a0,a0,1992 # 6240 <malloc+0x12ec>
...
0000000000002a8a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2adc:	e4050513          	add	a0,a0,-448 # 5918 <malloc+0x9c4>
    ...
    2af0:	6e450513          	add	a0,a0,1764 # 61d0 <malloc+0x127c>
    ...
    2b04:	75850513          	add	a0,a0,1880 # 6258 <malloc+0x1304>
    ...
    2b18:	70450513          	add	a0,a0,1796 # 6218 <malloc+0x12c4>
...
0000000000002b36 <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b92:	64250513          	add	a0,a0,1602 # 61d0 <malloc+0x127c>
    ...
    2ba6:	6d650513          	add	a0,a0,1750 # 6278 <malloc+0x1324>
    ...
    2bba:	6e250513          	add	a0,a0,1762 # 6298 <malloc+0x1344>
    ...
    2bce:	6e650513          	add	a0,a0,1766 # 62b0 <malloc+0x135c>
...
0000000000002bdc <subdir>:
{
  ...
  unlink("ff");
    ...
    2bee:	80e50513          	add	a0,a0,-2034 # 63f8 <malloc+0x14a4>
    2bf2:	6df010ef          	jal	4ad0 <unlink>
  if(mkdir("dd") != 0){
    2bf6:	00003517          	auipc	a0,0x3
    2bfa:	6d250513          	add	a0,a0,1746 # 62c8 <malloc+0x1374>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2c0e:	6de50513          	add	a0,a0,1758 # 62e8 <malloc+0x1394>
  ...
  write(fd, "ff", 2);
    ...
    2c22:	7da58593          	add	a1,a1,2010 # 63f8 <malloc+0x14a4>
  ...
  if(unlink("dd") >= 0){
    ...
    2c34:	69850513          	add	a0,a0,1688 # 62c8 <malloc+0x1374>
    2c38:	699010ef          	jal	4ad0 <unlink>
    2c3c:	2c055963          	bgez	a0,2f0e <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c40:	00003517          	auipc	a0,0x3
    2c44:	70050513          	add	a0,a0,1792 # 6340 <malloc+0x13ec>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c58:	71450513          	add	a0,a0,1812 # 6368 <malloc+0x1414>
  ...
  write(fd, "FF", 2);
    ...
    2c6c:	73058593          	add	a1,a1,1840 # 6398 <malloc+0x1444>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c80:	72450513          	add	a0,a0,1828 # 63a0 <malloc+0x144c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d66:	60650513          	add	a0,a0,1542 # 6368 <malloc+0x1414>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d7a:	80a50513          	add	a0,a0,-2038 # 6580 <malloc+0x162c>
  ...
  if(unlink("dd") < 0){
    ...
    2eec:	3e850513          	add	a0,a0,1000 # 62d0 <malloc+0x137c>
    ...
    2f00:	3f450513          	add	a0,a0,1012 # 62f0 <malloc+0x139c>
    ...
    2f14:	40050513          	add	a0,a0,1024 # 6310 <malloc+0x13bc>
    ...
    2f28:	42450513          	add	a0,a0,1060 # 6348 <malloc+0x13f4>
    ...
    2f3c:	44050513          	add	a0,a0,1088 # 6378 <malloc+0x1424>
    ...
    2f50:	46450513          	add	a0,a0,1124 # 63b0 <malloc+0x145c>
    ...
    2f64:	47050513          	add	a0,a0,1136 # 63d0 <malloc+0x147c>
    ...
    2f78:	48c50513          	add	a0,a0,1164 # 6400 <malloc+0x14ac>
    ...
    2f8c:	4a050513          	add	a0,a0,1184 # 6428 <malloc+0x14d4>
    ...
    2fa0:	4ac50513          	add	a0,a0,1196 # 6448 <malloc+0x14f4>
    ...
    2fb4:	4c050513          	add	a0,a0,1216 # 6470 <malloc+0x151c>
    ...
    2fc8:	4d450513          	add	a0,a0,1236 # 6498 <malloc+0x1544>
    ...
    2fdc:	4f050513          	add	a0,a0,1264 # 64c8 <malloc+0x1574>
    ...
    2ff0:	50c50513          	add	a0,a0,1292 # 64f8 <malloc+0x15a4>
    ...
    3004:	51050513          	add	a0,a0,1296 # 6510 <malloc+0x15bc>
    ...
    3018:	51c50513          	add	a0,a0,1308 # 6530 <malloc+0x15dc>
    ...
    302c:	52850513          	add	a0,a0,1320 # 6550 <malloc+0x15fc>
    ...
    3040:	55450513          	add	a0,a0,1364 # 6590 <malloc+0x163c>
    ...
    3054:	57050513          	add	a0,a0,1392 # 65c0 <malloc+0x166c>
    ...
    3068:	57c50513          	add	a0,a0,1404 # 65e0 <malloc+0x168c>
    ...
    307c:	58850513          	add	a0,a0,1416 # 6600 <malloc+0x16ac>
    ...
    3090:	59450513          	add	a0,a0,1428 # 6620 <malloc+0x16cc>
    ...
    30a4:	5b050513          	add	a0,a0,1456 # 6650 <malloc+0x16fc>
    ...
    30b8:	5c450513          	add	a0,a0,1476 # 6678 <malloc+0x1724>
    ...
    30cc:	5d850513          	add	a0,a0,1496 # 66a0 <malloc+0x174c>
    ...
    30e0:	5ec50513          	add	a0,a0,1516 # 66c8 <malloc+0x1774>
    ...
    30f4:	5f850513          	add	a0,a0,1528 # 66e8 <malloc+0x1794>
    ...
    3108:	60450513          	add	a0,a0,1540 # 6708 <malloc+0x17b4>
    ...
    311c:	61850513          	add	a0,a0,1560 # 6730 <malloc+0x17dc>
    ...
    3130:	62450513          	add	a0,a0,1572 # 6750 <malloc+0x17fc>
    ...
    3144:	63050513          	add	a0,a0,1584 # 6770 <malloc+0x181c>
    ...
    3158:	64450513          	add	a0,a0,1604 # 6798 <malloc+0x1844>
    ...
    316c:	2c050513          	add	a0,a0,704 # 6428 <malloc+0x14d4>
    ...
    3180:	63c50513          	add	a0,a0,1596 # 67b8 <malloc+0x1864>
    ...
    3194:	64850513          	add	a0,a0,1608 # 67d8 <malloc+0x1884>
    ...
    31a8:	66450513          	add	a0,a0,1636 # 6808 <malloc+0x18b4>
    ...
    31bc:	67050513          	add	a0,a0,1648 # 6828 <malloc+0x18d4>
...
00000000000031ca <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    3256:	5f650513          	add	a0,a0,1526 # 6848 <malloc+0x18f4>
    ...
    326a:	5fa50513          	add	a0,a0,1530 # 6860 <malloc+0x190c>
    ...
    327e:	5fe50513          	add	a0,a0,1534 # 6878 <malloc+0x1924>
    ...
    3292:	60250513          	add	a0,a0,1538 # 6890 <malloc+0x193c>
    ...
    32a6:	f9e50513          	add	a0,a0,-98 # 6240 <malloc+0x12ec>
    ...
    32ba:	5fa50513          	add	a0,a0,1530 # 68b0 <malloc+0x195c>
    ...
    32ce:	60e50513          	add	a0,a0,1550 # 68d8 <malloc+0x1984>
    ...
    32e2:	61a50513          	add	a0,a0,1562 # 68f8 <malloc+0x19a4>
...
00000000000032f0 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3306:	61650513          	add	a0,a0,1558 # 6918 <malloc+0x19c4>
  ...
  if(chdir("dirfile") == 0){
    ...
    331a:	60250513          	add	a0,a0,1538 # 6918 <malloc+0x19c4>
    331e:	7d2010ef          	jal	4af0 <chdir>
    3322:	c569                	beqz	a0,33ec <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    3324:	4581                	li	a1,0
    3326:	00003517          	auipc	a0,0x3
    332a:	63a50513          	add	a0,a0,1594 # 6960 <malloc+0x1a0c>
  ...
  fd = open(".", 0);
    ...
    33aa:	3ca50513          	add	a0,a0,970 # 5770 <malloc+0x81c>
    33ae:	712010ef          	jal	4ac0 <open>
    33b2:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    33b4:	4605                	li	a2,1
    33b6:	00002597          	auipc	a1,0x2
    33ba:	d4258593          	add	a1,a1,-702 # 50f8 <malloc+0x1a4>
  ...
  close(fd);
    ...
    33de:	54650513          	add	a0,a0,1350 # 6920 <malloc+0x19cc>
    ...
    33f2:	55250513          	add	a0,a0,1362 # 6940 <malloc+0x19ec>
    ...
    3406:	56e50513          	add	a0,a0,1390 # 6970 <malloc+0x1a1c>
    ...
    341a:	55a50513          	add	a0,a0,1370 # 6970 <malloc+0x1a1c>
    ...
    342e:	56e50513          	add	a0,a0,1390 # 6998 <malloc+0x1a44>
    ...
    3442:	58250513          	add	a0,a0,1410 # 69c0 <malloc+0x1a6c>
    ...
    3456:	59650513          	add	a0,a0,1430 # 69e8 <malloc+0x1a94>
    ...
    346a:	5aa50513          	add	a0,a0,1450 # 6a10 <malloc+0x1abc>
    ...
    347e:	5b650513          	add	a0,a0,1462 # 6a30 <malloc+0x1adc>
    ...
    3492:	5ca50513          	add	a0,a0,1482 # 6a58 <malloc+0x1b04>
...
00000000000034a0 <iref>:
{
    ...
    34be:	5b6a0a13          	add	s4,s4,1462 # 6a70 <malloc+0x1b1c>
    mkdir("");
    34c2:	00003497          	auipc	s1,0x3
    34c6:	0b648493          	add	s1,s1,182 # 6578 <malloc+0x1624>
    link("README", "");
    34ca:	00002a97          	auipc	s5,0x2
    34ce:	d96a8a93          	add	s5,s5,-618 # 5260 <malloc+0x30c>
    fd = open("xx", O_CREATE);
    34d2:	00003997          	auipc	s3,0x3
    34d6:	49698993          	add	s3,s3,1174 # 6968 <malloc+0x1a14>
    34da:	a835                	j	3516 <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34dc:	85da                	mv	a1,s6
    34de:	00003517          	auipc	a0,0x3
    34e2:	59a50513          	add	a0,a0,1434 # 6a78 <malloc+0x1b24>
    ...
    34f6:	59e50513          	add	a0,a0,1438 # 6a90 <malloc+0x1b3c>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    355e:	d3698993          	add	s3,s3,-714 # 6290 <malloc+0x133c>
    unlink("irefd");
    3562:	00003917          	auipc	s2,0x3
    3566:	50e90913          	add	s2,s2,1294 # 6a70 <malloc+0x1b1c>
    chdir("..");
    356a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    357e:	cbe50513          	add	a0,a0,-834 # 6238 <malloc+0x12e4>
...
000000000000359a <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    35aa:	50250513          	add	a0,a0,1282 # 6aa8 <malloc+0x1b54>
  ...
  if(pid == 0){
    ...
    35c6:	4e650513          	add	a0,a0,1254 # 6aa8 <malloc+0x1b54>
    ...
    35d8:	4f450513          	add	a0,a0,1268 # 6ac8 <malloc+0x1b74>
    ...
    35ec:	4c850513          	add	a0,a0,1224 # 6ab0 <malloc+0x1b5c>
    ...
    3600:	31c50513          	add	a0,a0,796 # 5918 <malloc+0x9c4>
...
000000000000364c <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    365c:	49850513          	add	a0,a0,1176 # 6af0 <malloc+0x1b9c>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    367c:	47850513          	add	a0,a0,1144 # 6af0 <malloc+0x1b9c>
  ...
  sleep(10); // one second
    ...
    36a4:	43850513          	add	a0,a0,1080 # 5ad8 <malloc+0xb84>
    ...
    36b6:	43e48493          	add	s1,s1,1086 # 6af0 <malloc+0x1b9c>
    36ba:	4581                	li	a1,0
    36bc:	8526                	mv	a0,s1
    ...
    36d6:	41e50513          	add	a0,a0,1054 # 6af0 <malloc+0x1b9c>
...
00000000000036ea <killstatus>:
{
  ...
  exit(0);
    ...
    373c:	1e050513          	add	a0,a0,480 # 5918 <malloc+0x9c4>
    ...
    3756:	3ae50513          	add	a0,a0,942 # 6b00 <malloc+0x1bac>
...
0000000000003764 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    378a:	35250513          	add	a0,a0,850 # 5ad8 <malloc+0xb84>
  ...
  if(pid2 == 0)
    ...
    37ac:	17050513          	add	a0,a0,368 # 5918 <malloc+0x9c4>
  ...
  if(pid3 == 0){
    ...
    37dc:	92058593          	add	a1,a1,-1760 # 50f8 <malloc+0x1a4>
    ...
    37fe:	11e50513          	add	a0,a0,286 # 5918 <malloc+0x9c4>
    ...
    3812:	31250513          	add	a0,a0,786 # 6b20 <malloc+0x1bcc>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3842:	2fa50513          	add	a0,a0,762 # 6b38 <malloc+0x1be4>
  ...
  printf("kill... ");
    ...
    3866:	2ee50513          	add	a0,a0,750 # 6b50 <malloc+0x1bfc>
  ...
  printf("wait... ");
    ...
    3884:	2e050513          	add	a0,a0,736 # 6b60 <malloc+0x1c0c>
...
00000000000038a0 <reparent>:
{
  ...
  exit(0);
    ...
    38e4:	03850513          	add	a0,a0,56 # 5918 <malloc+0x9c4>
    ...
    38f8:	1ac50513          	add	a0,a0,428 # 5aa0 <malloc+0xb4c>
...
0000000000003920 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3952:	0d250513          	add	a0,a0,210 # 5a20 <malloc+0xacc>
    ...
    3976:	78658593          	add	a1,a1,1926 # 50f8 <malloc+0x1a4>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    3a16:	15e50513          	add	a0,a0,350 # 6b70 <malloc+0x1c1c>
    ...
    3a2a:	ef250513          	add	a0,a0,-270 # 5918 <malloc+0x9c4>
    ...
    3a66:	12e50513          	add	a0,a0,302 # 6b90 <malloc+0x1c3c>
...
0000000000003a7a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ade:	0e650513          	add	a0,a0,230 # 6bc0 <malloc+0x1c6c>
...
0000000000003af2 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b02:	0e250513          	add	a0,a0,226 # 6be0 <malloc+0x1c8c>
    3b06:	7cb000ef          	jal	4ad0 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b0a:	20200593          	li	a1,514
    3b0e:	00003517          	auipc	a0,0x3
    3b12:	0d250513          	add	a0,a0,210 # 6be0 <malloc+0x1c8c>
  ...
  if(pid == 0) {
    ...
    3b7c:	07850513          	add	a0,a0,120 # 6bf0 <malloc+0x1c9c>
    ...
    3b90:	08c50513          	add	a0,a0,140 # 6c18 <malloc+0x1cc4>
  ...
  fd = open("sharedfd", 0);
    ...
    3bc0:	02450513          	add	a0,a0,36 # 6be0 <malloc+0x1c8c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3bf8:	04450513          	add	a0,a0,68 # 6c38 <malloc+0x1ce4>
  ...
  unlink("sharedfd");
    ...
    3c28:	fbc50513          	add	a0,a0,-68 # 6be0 <malloc+0x1c8c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c4a:	01a50513          	add	a0,a0,26 # 6c60 <malloc+0x1d0c>
...
0000000000003c5e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c82:	ffa78793          	add	a5,a5,-6 # 6c78 <malloc+0x1d24>
    3c86:	f6f43823          	sd	a5,-144(s0)
    3c8a:	00003797          	auipc	a5,0x3
    3c8e:	ff678793          	add	a5,a5,-10 # 6c80 <malloc+0x1d2c>
    3c92:	f6f43c23          	sd	a5,-136(s0)
    3c96:	00003797          	auipc	a5,0x3
    3c9a:	ff278793          	add	a5,a5,-14 # 6c88 <malloc+0x1d34>
    3c9e:	f8f43023          	sd	a5,-128(s0)
    3ca2:	00003797          	auipc	a5,0x3
    3ca6:	fee78793          	add	a5,a5,-18 # 6c90 <malloc+0x1d3c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d08:	c1450513          	add	a0,a0,-1004 # 5918 <malloc+0x9c4>
    ...
    3d6a:	c4a50513          	add	a0,a0,-950 # 59b0 <malloc+0xa5c>
    ...
    3d7c:	f2050513          	add	a0,a0,-224 # 6c98 <malloc+0x1d44>
    ...
    3d96:	f1e50513          	add	a0,a0,-226 # 6cb0 <malloc+0x1d5c>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e06:	ebe50513          	add	a0,a0,-322 # 6cc0 <malloc+0x1d6c>
...
0000000000003e32 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e60:	e7cb8b93          	add	s7,s7,-388 # 6cd8 <malloc+0x1d84>
  for(i = 0; i < N; i++){
    ...
    3e9a:	e4a50513          	add	a0,a0,-438 # 6ce0 <malloc+0x1d8c>
    ...
    3eb0:	e2c50513          	add	a0,a0,-468 # 6cd8 <malloc+0x1d84>
  ...
  fd = open(".", 0);
    ...
    3ed8:	89c50513          	add	a0,a0,-1892 # 5770 <malloc+0x81c>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f48:	dbc50513          	add	a0,a0,-580 # 6d00 <malloc+0x1dac>
    ...
    3f60:	dc450513          	add	a0,a0,-572 # 6d20 <malloc+0x1dcc>
  ...
  for(i = 0; i < N; i++){
    ...
    3f8c:	dc050513          	add	a0,a0,-576 # 6d48 <malloc+0x1df4>
    ...
    3fa0:	97c50513          	add	a0,a0,-1668 # 5918 <malloc+0x9c4>
...
00000000000040d6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40ee:	c9650513          	add	a0,a0,-874 # 6d80 <malloc+0x1e2c>
    40f2:	1df000ef          	jal	4ad0 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40f6:	20200593          	li	a1,514
    40fa:	00003517          	auipc	a0,0x3
    40fe:	c8650513          	add	a0,a0,-890 # 6d80 <malloc+0x1e2c>
  ...
  fd = open("bigfile.dat", 0);
    ...
    414a:	c3a50513          	add	a0,a0,-966 # 6d80 <malloc+0x1e2c>
  ...
  for(i = 0; ; i++){
    ...
    41a6:	bee50513          	add	a0,a0,-1042 # 6d90 <malloc+0x1e3c>
    ...
    41ba:	bfa50513          	add	a0,a0,-1030 # 6db0 <malloc+0x1e5c>
    ...
    41ce:	c0650513          	add	a0,a0,-1018 # 6dd0 <malloc+0x1e7c>
    ...
    41e2:	c1250513          	add	a0,a0,-1006 # 6df0 <malloc+0x1e9c>
    ...
    41f6:	c1e50513          	add	a0,a0,-994 # 6e10 <malloc+0x1ebc>
    ...
    420a:	c2250513          	add	a0,a0,-990 # 6e28 <malloc+0x1ed4>
  ...
  unlink("bigfile.dat");
    ...
    422c:	b5850513          	add	a0,a0,-1192 # 6d80 <malloc+0x1e2c>
    ...
    424c:	c0050513          	add	a0,a0,-1024 # 6e48 <malloc+0x1ef4>
...
000000000000425a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    426a:	c0250513          	add	a0,a0,-1022 # 6e68 <malloc+0x1f14>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4290:	bdc50513          	add	a0,a0,-1060 # 6e68 <malloc+0x1f14>
  ...
  close(fd);
    ...
    42ea:	da250513          	add	a0,a0,-606 # 5088 <malloc+0x134>
    42ee:	7ca000ef          	jal	4ab8 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42f2:	20000593          	li	a1,512
    42f6:	00003517          	auipc	a0,0x3
    42fa:	b7250513          	add	a0,a0,-1166 # 6e68 <malloc+0x1f14>
    ...
    4312:	b6a50513          	add	a0,a0,-1174 # 6e78 <malloc+0x1f24>
    ...
    432a:	b7250513          	add	a0,a0,-1166 # 6e98 <malloc+0x1f44>
...
0000000000004338 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4358:	b6450513          	add	a0,a0,-1180 # 6eb8 <malloc+0x1f64>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4374:	b58c8c93          	add	s9,s9,-1192 # 6ec8 <malloc+0x1f74>
    name[0] = 'f';
    ...
    43dc:	b0050513          	add	a0,a0,-1280 # 6ed8 <malloc+0x1f84>
  ...
  printf("fsfull test finished\n");
    ...
    444a:	ab250513          	add	a0,a0,-1358 # 6ef8 <malloc+0x1fa4>
    ...
    4498:	a5450513          	add	a0,a0,-1452 # 6ee8 <malloc+0x1f94>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    44c2:	a5250513          	add	a0,a0,-1454 # 6f10 <malloc+0x1fbc>
  ...
  if(pid == 0) {
    ...
    44e6:	a5650513          	add	a0,a0,-1450 # 6f38 <malloc+0x1fe4>
    ...
    4506:	a1e50513          	add	a0,a0,-1506 # 6f20 <malloc+0x1fcc>
    ...
    4522:	a2250513          	add	a0,a0,-1502 # 6f40 <malloc+0x1fec>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    457a:	9d250513          	add	a0,a0,-1582 # 6f48 <malloc+0x1ff4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    45da:	b2298993          	add	s3,s3,-1246 # 50f8 <malloc+0x1a4>
      uint64 a = (uint64) sbrk(4096);
    ...
    4604:	9a050513          	add	a0,a0,-1632 # 6fa0 <malloc+0x204c>
    ...
    461c:	94850513          	add	a0,a0,-1720 # 6f60 <malloc+0x200c>
    ...
    4634:	95050513          	add	a0,a0,-1712 # 6f80 <malloc+0x202c>
  ...
  while(1){
    ...
    4674:	95050513          	add	a0,a0,-1712 # 6fc0 <malloc+0x206c>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    46c2:	922b8b93          	add	s7,s7,-1758 # 6fe0 <malloc+0x208c>
    int free0 = countfree();
    int free1 = 0;
    ...
    46dc:	920d0d13          	add	s10,s10,-1760 # 6ff8 <malloc+0x20a4>
          return 1;
        }
      }
    }
    ...
    46e4:	938c8c93          	add	s9,s9,-1736 # 7018 <malloc+0x20c4>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    47a0:	8ac58593          	add	a1,a1,-1876 # 7048 <malloc+0x20f4>
    47a4:	854a                	mv	a0,s2
    ...
    47b2:	8a258593          	add	a1,a1,-1886 # 7050 <malloc+0x20fc>
    47b6:	854a                	mv	a0,s2
    47b8:	08c000ef          	jal	4844 <strcmp>
    47bc:	cd15                	beqz	a0,47f8 <main+0x8e>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    47be:	00003597          	auipc	a1,0x3
    47c2:	89a58593          	add	a1,a1,-1894 # 7058 <malloc+0x2104>
    47c6:	854a                	mv	a0,s2
  ...
  int continuous = 0;
    ...
    47e4:	88050513          	add	a0,a0,-1920 # 7060 <malloc+0x210c>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4808:	88c50513          	add	a0,a0,-1908 # 7090 <malloc+0x213c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    4b68:	8fc50513          	add	a0,a0,-1796 # 7460 <digits>
    4b6c:	883a                	mv	a6,a4
    4b6e:	2705                	addw	a4,a4,1
    4b70:	02c5f7bb          	remuw	a5,a1,a2
    4b74:	1782                	sll	a5,a5,0x20
    4b76:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    4dfe:	666b8b93          	add	s7,s7,1638 # 7460 <digits>
    4e02:	03c9d793          	srl	a5,s3,0x3c
    4e06:	97de                	add	a5,a5,s7
    4e08:	0007c583          	lbu	a1,0(a5)
    4e0c:	855a                	mv	a0,s6
    4e0e:	d1bff0ef          	jal	4b28 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    4e12:	0992                	sll	s3,s3,0x4
    4e14:	397d                	addw	s2,s2,-1
    ...
    4e4c:	59890913          	add	s2,s2,1432 # 73e0 <malloc+0x248c>
        for(; *s; s++)
...
{
    4e76:	715d                	add	sp,sp,-80
    4e78:	ec06                	sd	ra,24(sp)
    4e7a:	e822                	sd	s0,16(sp)
    4e7c:	1000                	add	s0,sp,32
...
{
    4ea0:	711d                	add	sp,sp,-96
    4ea2:	ec06                	sd	ra,24(sp)
    4ea4:	e822                	sd	s0,16(sp)
    4ea6:	1000                	add	s0,sp,32
...
free(void *ap)
{
    4ed2:	1141                	add	sp,sp,-16
    4ed4:	e422                	sd	s0,8(sp)
    4ed6:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    4ed8:	ff050693          	add	a3,a0,-16
    ...
    4f08:	00e6ea63          	bltu	a3,a4,4f1c <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    4f22:	02059813          	sll	a6,a1,0x20
    4f26:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    4f36:	02061593          	sll	a1,a2,0x20
    4f3a:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    4f54:	7139                	add	sp,sp,-64
    4f56:	fc06                	sd	ra,56(sp)
    4f58:	f822                	sd	s0,48(sp)
    4f5a:	f426                	sd	s1,40(sp)
    4f5c:	ec4e                	sd	s3,24(sp)
    4f5e:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    4f60:	02051493          	sll	s1,a0,0x20
    4f64:	9081                	srl	s1,s1,0x20
    4f66:	04bd                	add	s1,s1,15
    4f68:	8091                	srl	s1,s1,0x4
    4f6a:	0014899b          	addw	s3,s1,1
    4f6e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    4fa4:	4b090913          	add	s2,s2,1200 # 8450 <freep>
  if(p == (char*)-1)
    4fa8:	5afd                	li	s5,-1
    ...
    4fb8:	cc478793          	add	a5,a5,-828 # ec78 <base>
  ...
  if(p == (char*)-1)
    ...
    501a:	c798                	sw	a4,8(a5)
        p += p->s.size;
    501c:	02071693          	sll	a3,a4,0x20
    5020:	01c6d713          	srl	a4,a3,0x1c
