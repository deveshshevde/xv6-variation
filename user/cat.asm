...
cat(int fd)
{
  ...
  3c:	8e858593          	add	a1,a1,-1816 # 920 <malloc+0xf8>
  40:	4509                	li	a0,2
  ...
  62:	8da58593          	add	a1,a1,-1830 # 938 <malloc+0x110>
  66:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
  ...
  da:	87a58593          	add	a1,a1,-1926 # 950 <malloc+0x128>
  de:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43c:	53850513          	add	a0,a0,1336 # 970 <digits>
 440:	883a                	mv	a6,a4
 442:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6d2:	2a2b8b93          	add	s7,s7,674 # 970 <digits>
 ...
 6e6:	0992                	sll	s3,s3,0x4
 6e8:	397d                	addw	s2,s2,-1
 ...
 720:	24c90913          	add	s2,s2,588 # 968 <malloc+0x140>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 832:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 834:	02051493          	sll	s1,a0,0x20
 838:	9081                	srl	s1,s1,0x20
 83a:	04bd                	add	s1,s1,15
 83c:	8091                	srl	s1,s1,0x4
 83e:	0014899b          	addw	s3,s1,1
 842:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 8ee:	c798                	sw	a4,8(a5)
        p += p->s.size;
 8f0:	02071693          	sll	a3,a4,0x20
 8f4:	01c6d713          	srl	a4,a3,0x1c
