...
main(int argc, char **argv)
{
  ...
  44:	85058593          	add	a1,a1,-1968 # 890 <malloc+0xfe>
  48:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a6:	50e50513          	add	a0,a0,1294 # 8b0 <digits>
 3aa:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 63c:	278b8b93          	add	s7,s7,632 # 8b0 <digits>
 ...
 68a:	22290913          	add	s2,s2,546 # 8a8 <malloc+0x116>
        for(; *s; s++)
