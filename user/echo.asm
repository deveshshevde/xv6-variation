...
main(int argc, char *argv[])
{
  ...
  34:	880a8a93          	add	s5,s5,-1920 # 8b0 <malloc+0xf8>
  ...
  6a:	85258593          	add	a1,a1,-1966 # 8b8 <malloc+0x100>
  6e:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3cc:	50050513          	add	a0,a0,1280 # 8c8 <digits>
 3d0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 662:	26ab8b93          	add	s7,s7,618 # 8c8 <digits>
 ...
 6b0:	21490913          	add	s2,s2,532 # 8c0 <malloc+0x108>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 808:	7fc90913          	add	s2,s2,2044 # 1000 <freep>
  if(p == (char*)-1)
 80c:	5afd                	li	s5,-1
 ...
 87e:	c798                	sw	a4,8(a5)
        p += p->s.size;
 880:	02071693          	sll	a3,a4,0x20
 884:	01c6d713          	srl	a4,a3,0x1c
