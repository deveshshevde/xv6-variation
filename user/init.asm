...
main(void)
{
  ...
  12:	8f250513          	add	a0,a0,-1806 # 900 <malloc+0x106>
  ...
  2e:	8de90913          	add	s2,s2,-1826 # 908 <malloc+0x10e>
  32:	854a                	mv	a0,s2
  ...
  56:	90650513          	add	a0,a0,-1786 # 958 <malloc+0x15e>
  ...
  6c:	89850513          	add	a0,a0,-1896 # 900 <malloc+0x106>
  70:	2fe000ef          	jal	36e <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	88a50513          	add	a0,a0,-1910 # 900 <malloc+0x106>
  7e:	2e8000ef          	jal	366 <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	89c50513          	add	a0,a0,-1892 # 920 <malloc+0x126>
  ...
  a2:	89a50513          	add	a0,a0,-1894 # 938 <malloc+0x13e>
  a6:	2b8000ef          	jal	35e <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	89650513          	add	a0,a0,-1898 # 940 <malloc+0x146>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 40e:	57650513          	add	a0,a0,1398 # 980 <digits>
 412:	883a                	mv	a6,a4
 414:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a4:	2e0b8b93          	add	s7,s7,736 # 980 <digits>
 ...
 6f2:	28a90913          	add	s2,s2,650 # 978 <malloc+0x17e>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 84a:	7ca90913          	add	s2,s2,1994 # 1010 <freep>
  if(p == (char*)-1)
 84e:	5afd                	li	s5,-1
 ...
 85e:	7c678793          	add	a5,a5,1990 # 1020 <base>
