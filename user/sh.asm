...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	1be58593          	add	a1,a1,446 # 11d0 <malloc+0x100>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	18c58593          	add	a1,a1,396 # 11e0 <malloc+0x110>
      5c:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	16650513          	add	a0,a0,358 # 11e8 <malloc+0x118>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	23e70713          	add	a4,a4,574 # 12e8 <malloc+0x218>
    ...
    panic("runcmd");
      ...
      c6:	12e50513          	add	a0,a0,302 # 11f0 <malloc+0x120>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	11c58593          	add	a1,a1,284 # 11f8 <malloc+0x128>
      e4:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     114:	0f858593          	add	a1,a1,248 # 1208 <malloc+0x138>
     118:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     176:	0a650513          	add	a0,a0,166 # 1218 <malloc+0x148>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	d74a8a93          	add	s5,s5,-652 # 1240 <malloc+0x170>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	d4250513          	add	a0,a0,-702 # 1220 <malloc+0x150>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	cae60613          	add	a2,a2,-850 # 1248 <malloc+0x178>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	c9eb0b13          	add	s6,s6,-866 # 1268 <malloc+0x198>
  ...
  return ret;
     ...
     5f8:	c5c50513          	add	a0,a0,-932 # 1250 <malloc+0x180>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c1250513          	add	a0,a0,-1006 # 1258 <malloc+0x188>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	bec60613          	add	a2,a2,-1044 # 1270 <malloc+0x1a0>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	b98a0a13          	add	s4,s4,-1128 # 1278 <malloc+0x1a8>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	b7660613          	add	a2,a2,-1162 # 1280 <malloc+0x1b0>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	ae860613          	add	a2,a2,-1304 # 1248 <malloc+0x178>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b1460613          	add	a2,a2,-1260 # 1298 <malloc+0x1c8>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	ace50513          	add	a0,a0,-1330 # 1288 <malloc+0x1b8>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	ada50513          	add	a0,a0,-1318 # 12a0 <malloc+0x1d0>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b1270713          	add	a4,a4,-1262 # 1300 <malloc+0x230>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	95e60613          	add	a2,a2,-1698 # 11d8 <malloc+0x108>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a1058593          	add	a1,a1,-1520 # 12b8 <malloc+0x1e8>
     8b0:	4509                	li	a0,2
     8b2:	740000ef          	jal	ff2 <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	99a50513          	add	a0,a0,-1638 # 1250 <malloc+0x180>
     8be:	f8cff0ef          	jal	4a <panic>

00000000000008c2 <main>:
{
     8c2:	7179                	add	sp,sp,-48
     ...
     8cc:	e44e                	sd	s3,8(sp)
     8ce:	e052                	sd	s4,0(sp)
     8d0:	1800                	add	s0,sp,48
  while((fd = open("console", O_RDWR)) >= 0){
     8d2:	00001497          	auipc	s1,0x1
     8d6:	9f648493          	add	s1,s1,-1546 # 12c8 <malloc+0x1f8>
     8da:	4589                	li	a1,2
     8dc:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     8f4:	73048493          	add	s1,s1,1840 # 2020 <buf.0>
...
start()
{
     992:	1141                	add	sp,sp,-16
     994:	e406                	sd	ra,8(sp)
     996:	e022                	sd	s0,0(sp)
     998:	0800                	add	s0,sp,16
  extern int main();
  main();
...
{
     9c0:	1141                	add	sp,sp,-16
     9c2:	e422                	sd	s0,8(sp)
     9c4:	0800                	add	s0,sp,16
  while(*p && *p == *q)
    ...
    p++, q++;
     9d4:	0505                	add	a0,a0,1
     9d6:	0585                	add	a1,a1,1
  while(*p && *p == *q)
...
{
     a16:	1141                	add	sp,sp,-16
     a18:	e422                	sd	s0,8(sp)
     a1a:	0800                	add	s0,sp,16
  char *cdst = (char *) dst;
  int i;
  for(i = 0; i < n; i++){
     a1c:	ca19                	beqz	a2,a32 <memset+0x1c>
     a1e:	87aa                	mv	a5,a0
     a20:	1602                	sll	a2,a2,0x20
     a22:	9201                	srl	a2,a2,0x20
     a24:	00a60733          	add	a4,a2,a0
    cdst[i] = c;
     a28:	00b78023          	sb	a1,0(a5)
  for(i = 0; i < n; i++){
     a2c:	0785                	add	a5,a5,1
     a2e:	fee79de3          	bne	a5,a4,a28 <memset+0x12>
  }
  return dst;
}
     a32:	6422                	ld	s0,8(sp)
     a34:	0141                	add	sp,sp,16
     a36:	8082                	ret
...
{
     a38:	1141                	add	sp,sp,-16
     a3a:	e422                	sd	s0,8(sp)
     a3c:	0800                	add	s0,sp,16
  for(; *s; s++)
...
atoi(const char *s)
{
     b06:	1141                	add	sp,sp,-16
     b08:	e422                	sd	s0,8(sp)
     b0a:	0800                	add	s0,sp,16
  int n;

  n = 0;
  while('0' <= *s && *s <= '9')
     b0c:	00054683          	lbu	a3,0(a0)
     b10:	fd06879b          	addw	a5,a3,-48
  ...
  n = 0;
     b20:	4501                	li	a0,0
    n = n*10 + *s++ - '0';
     b22:	0705                	add	a4,a4,1
     b24:	0025179b          	sllw	a5,a0,0x2
     b28:	9fa9                	addw	a5,a5,a0
     b2a:	0017979b          	sllw	a5,a5,0x1
     b2e:	9fb5                	addw	a5,a5,a3
     b30:	fd07851b          	addw	a0,a5,-48
  while('0' <= *s && *s <= '9')
     b34:	00074683          	lbu	a3,0(a4)
     b38:	fd06879b          	addw	a5,a3,-48
     b3c:	0ff7f793          	zext.b	a5,a5
     b40:	fef671e3          	bgeu	a2,a5,b22 <atoi+0x1c>
  return n;
}
     b44:	6422                	ld	s0,8(sp)
     b46:	0141                	add	sp,sp,16
     b48:	8082                	ret
  n = 0;
     b4a:	4501                	li	a0,0
...
{
     b4e:	1141                	add	sp,sp,-16
     b50:	e422                	sd	s0,8(sp)
     b52:	0800                	add	s0,sp,16
  char *dst;
  const char *src;
  ...
  if (src > dst) {
    ...
    while(n-- > 0)
     ...
     b5c:	1602                	sll	a2,a2,0x20
     b5e:	9201                	srl	a2,a2,0x20
     b60:	00c507b3          	add	a5,a0,a2
  dst = vdst;
     b64:	872a                	mv	a4,a0
      *dst++ = *src++;
     b66:	0585                	add	a1,a1,1
     b68:	0705                	add	a4,a4,1
  ...
  return vdst;
    ...
    while(n-- > 0)
     ...
     b86:	fff6079b          	addw	a5,a2,-1
     b8a:	1782                	sll	a5,a5,0x20
     b8c:	9381                	srl	a5,a5,0x20
     b8e:	fff7c793          	not	a5,a5
     b92:	97ba                	add	a5,a5,a4
      *--dst = *--src;
     b94:	15fd                	add	a1,a1,-1
     b96:	177d                	add	a4,a4,-1
...
memcmp(const void *s1, const void *s2, uint n)
{
  ...
  while (n-- > 0) {
     ...
     bae:	fff6069b          	addw	a3,a2,-1
     bb2:	1682                	sll	a3,a3,0x20
     bb4:	9281                	srl	a3,a3,0x20
     bb6:	0685                	add	a3,a3,1
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ce4:	63850513          	add	a0,a0,1592 # 1318 <digits>
     ce8:	883a                	mv	a6,a4
     cea:	2705                	addw	a4,a4,1
     cec:	02c5f7bb          	remuw	a5,a1,a2
     cf0:	1782                	sll	a5,a5,0x20
     cf2:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f7a:	3a2b8b93          	add	s7,s7,930 # 1318 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ...
     fc8:	31c90913          	add	s2,s2,796 # 12e0 <malloc+0x210>
        for(; *s; s++)
...
malloc(uint nbytes)
{
    ...
    10da:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    10dc:	02051493          	sll	s1,a0,0x20
    10e0:	9081                	srl	s1,s1,0x20
    10e2:	04bd                	add	s1,s1,15
    10e4:	8091                	srl	s1,s1,0x4
    10e6:	0014899b          	addw	s3,s1,1
    10ea:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  if(p == (char*)-1)
    ...
    1196:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1198:	02071693          	sll	a3,a4,0x20
    119c:	01c6d713          	srl	a4,a3,0x1c
