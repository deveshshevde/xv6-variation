...
wc(int fd, char *name)
{
  ...
  3c:	968a0a13          	add	s4,s4,-1688 # 9a0 <malloc+0x106>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	92250513          	add	a0,a0,-1758 # 9c0 <malloc+0x126>
  ...
  cc:	8e850513          	add	a0,a0,-1816 # 9b0 <malloc+0x116>
...
main(int argc, char *argv[])
{
 ...
 136:	87658593          	add	a1,a1,-1930 # 9a8 <malloc+0x10e>
 13a:	4501                	li	a0,0
 ...
 14e:	88650513          	add	a0,a0,-1914 # 9d0 <malloc+0x136>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	54650513          	add	a0,a0,1350 # 9f0 <digits>
 4b2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 744:	2b0b8b93          	add	s7,s7,688 # 9f0 <digits>
 ...
 758:	0992                	sll	s3,s3,0x4
 75a:	397d                	addw	s2,s2,-1
 ...
 792:	25a90913          	add	s2,s2,602 # 9e8 <malloc+0x14e>
        for(; *s; s++)
...
{
 7bc:	715d                	add	sp,sp,-80
 7be:	ec06                	sd	ra,24(sp)
 7c0:	e822                	sd	s0,16(sp)
 7c2:	1000                	add	s0,sp,32
 7c4:	e010                	sd	a2,0(s0)
 7c6:	e414                	sd	a3,8(s0)
...
malloc(uint nbytes)
{
 ...
 8fe:	91678793          	add	a5,a5,-1770 # 1210 <base>
 ...
 960:	c798                	sw	a4,8(a5)
        p += p->s.size;
 962:	02071693          	sll	a3,a4,0x20
 966:	01c6d713          	srl	a4,a3,0x1c
