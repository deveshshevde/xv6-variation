...
main(int argc, char *argv[])
{
  ...
  40:	86458593          	add	a1,a1,-1948 # 8a0 <malloc+0xfc>
  44:	4509                	li	a0,2
  ...
  56:	86658593          	add	a1,a1,-1946 # 8b8 <malloc+0x114>
  5a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b8:	52c50513          	add	a0,a0,1324 # 8e0 <digits>
 3bc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 64e:	296b8b93          	add	s7,s7,662 # 8e0 <digits>
 ...
 69c:	24090913          	add	s2,s2,576 # 8d8 <malloc+0x134>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 7ae:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 7b0:	02051493          	sll	s1,a0,0x20
 7b4:	9081                	srl	s1,s1,0x20
 7b6:	04bd                	add	s1,s1,15
 7b8:	8091                	srl	s1,s1,0x4
 7ba:	0014899b          	addw	s3,s1,1
 7be:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
