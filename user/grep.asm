...
00000000000001c4 <main>:
{
 ...
 226:	86e58593          	add	a1,a1,-1938 # a90 <malloc+0xf8>
 22a:	4509                	li	a0,2
 ...
 24c:	86850513          	add	a0,a0,-1944 # ab0 <malloc+0x118>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5ac:	52850513          	add	a0,a0,1320 # ad0 <digits>
 5b0:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 842:	292b8b93          	add	s7,s7,658 # ad0 <digits>
 846:	03c9d793          	srl	a5,s3,0x3c
 ...
 890:	23c90913          	add	s2,s2,572 # ac8 <malloc+0x130>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 9fc:	a1878793          	add	a5,a5,-1512 # 1410 <base>
 ...
 a5e:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a60:	02071693          	sll	a3,a4,0x20
 a64:	01c6d713          	srl	a4,a3,0x1c
