...
user/_off:     file format elf64-littleriscv
...
int main(int argc, char *argv[]) {
   ...
   6:	0800                	add	s0,sp,16
    off();
   8:	320000ef          	jal	328 <off>
    printf("Reboot failed!\n");
   c:	00001517          	auipc	a0,0x1
  10:	85450513          	add	a0,a0,-1964 # 860 <malloc+0x104>
  14:	694000ef          	jal	6a8 <printf>
    exit(1);
  18:	4505                	li	a0,1
  1a:	26e000ef          	jal	288 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 370:	50c50513          	add	a0,a0,1292 # 878 <digits>
 374:	883a                	mv	a6,a4
 376:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 606:	276b8b93          	add	s7,s7,630 # 878 <digits>
 ...
 654:	22090913          	add	s2,s2,544 # 870 <malloc+0x114>
        for(; *s; s++)
